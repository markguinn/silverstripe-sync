...
{
    public static $url_segment = 'sync';
    public static $allow_jsonp = true;
    public static $allow_crossdomain = true;
    public static $date_format = 'c';
